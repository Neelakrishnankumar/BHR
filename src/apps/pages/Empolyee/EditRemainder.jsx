        ...
        await dispatch(
          BirthdayAnniversaryGet({
            data: {
              ...
              ClassificationID: className?.map((C) => C.RecordID).join(",")
            },
          })
        );
      } catch (err) {
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          {/* CLASSIFICATION - now supports "Select All" via EventsmultiSelect */}
                          <ClassmultiSelect
                            sx={{
                              width: 275,
                            ...
                            onChange={(e, newValue) => {
                              setFieldValue("ProName", newValue, true);
                            ...
                            url={`${listViewurl}?data=${JSON.stringify({
                              Query: {
                                ...
                                Filter:
                                  values.category === "Work Anniversary"
                            ...
                            <Button
                              onClick={async () => {
                                try {
                                  ...
                                  const blob =
                                    await generatePDFInBackground(pdfComponent);
