...
// // import GenerateGPT from "@mui/icons-material/GenerateGPT";
...
//     const Subjectrows = useSelector((state) => state.formApi.Data?.Subjects);

//   // const Subjectrows = useSelector((s) => s.exploreApi.explorerowData);
...
//   //   if (!values.Slotgroup) {
//   //     toast.error("Please select a slot group");
//   //     return;
//   //   }

//   //   setIsGenerating(true);
//   //   try {
//   //     // Build the timetable generation payload
//   //     const payload = {
...
//   //         maxPeriodsPerTeacher: rules.maxPeriodsPerTeacher,
//   //       },
//   //     };

//   //     console.log("Generating timetable with:", payload);

//   //     // Call API to generate timetable
//   //     const response = await dispatch(
//   //       TimeTableGenerateget({
//   //         accessID: "TR368v1",
//   //         action: "generate", // New action for generation
//   //         idata: payload,
//   //       })
//   //     );
...
//   //       setGenerationStep(1); // Move to generated view

//   //       // Refresh the grid data
//   //       dispatch(getFetchData({ accessID: "TR368", get: "get", recID }));
//   //     } else {
//   //       toast.error(response?.payload?.Msg || "Failed to generate timetable");
//   //     }
//   //   } catch (err) {
...
//           //   Periods: Number(s.periods || s["Periods/Week"] || 0),
//           // })),
...
//       } else {
//         toast.error(
//           response?.payload?.Msg || "Failed to generate timetable"
//         );
//       }
//     } catch (err) {
//       console.error("Generation error:", err);
...
//   const [rows, setRows] = React.useState(Subjectrows ? Subjectrows : []);
...
const EditTimetablev1 = () => {
    ...
    try {
      ...
      const payload = {
        ...
        data: {
          ...
          SlotGroupID: values.Slotgroup?.RecordID?.toString() || "0",
          Description: values.description || "",
          TotalWeekSlots: data?.TotalWeekSlots != 0 ? data?.TotalWeekSlots : totalWeekSlots,
          Subjects: rows.map((s) => ({
            DepartmentID:
              s.DepartmentID?.toString() ||
              s.Department?.RecordID?.toString() ||
  ...
  const processRowUpdate = (newRow) => {
    ...
    if (newRow.periods === "" || newRow.periods === 0 ||newRow.periods === null || newRow.periods === undefined) {
      ...
      throw new Error("Periods/Week is mandatory.");
    }
