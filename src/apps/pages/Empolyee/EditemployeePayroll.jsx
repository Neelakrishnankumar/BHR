...
const EditemployeePayroll = () => {
  ...
  const AllDedInitialValues = {
    ...
    imageurl: Data.ImageName
      ...
      : store.getState().globalurl.imageUrl + "Defaultimg.jpg",
    salaryCategory:
      ADLookupData.adCategory === "A"
        ? "Allowances"
        : ADLookupData.adCategory === "D"
        ? "Deductions"
        : ADLookupData.adCategory,
                ...
                >
                  ...
                  >
                    ...
                    <FormControl sx={{ gridColumn: "span 2", gap: "30px" }}>
                      ...
                      >
                        <InputLabel variant="filled" id="LeavePart">
                          {
                            <span>
