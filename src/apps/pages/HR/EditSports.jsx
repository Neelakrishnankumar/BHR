...
const EditSports = () => {
  ...
  useEffect(() => {
    dispatch(
      EventsgetData({ accessID: "TR385", get: "get", recID, Type: "S" }),
    );
  ...
  const InitialValue = {
    ...
    RegistrationRequired:
      mode === "E" ? (data?.RegistrationRequired === "Y" ? true : false) : true,
    // SyllabusFile: null,
  };
             ...
             margin: "0 4px",
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/Secondarylistview/${params.accessID}/${params.screenName}/${params.leaderID}/Events/${params.secondaryAccessID}/${params.parentID2}/S`,
                          {
                            state: { ...state },
                          },
                        );
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                Manage and track sports activities and events
                              </Typography>
                            </Box>
                          </Box>
                          <Box
