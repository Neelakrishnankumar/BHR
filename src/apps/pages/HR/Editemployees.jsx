...
import { fileUpload, fnFileUpload } from "../../../store/reducers/Imguploadreducer";
...
const Editemployee = () => {
  ...
  const parentcontactInitialValue = {
    ...
    ContactPersonIDProofImg1:
      ParentcontactgetData.ContactPersonIDProofImageOne || "",
    ContactPersonIDProofImg2:
      ParentcontactgetData.ContactPersonIDProofImageTwo || "",
  };
  ...
  const contactsave = async (values, del) => {
    ...
    const idata = {
      ...
      ContactPersonIDProofImg1: ID1Image || ParentcontactgetData.ContactPersonIDProofImageOne || "",
      ContactPersonIDProofImg2: ID2Image || ParentcontactgetData.ContactPersonIDProofImageTwo || "",
    };
...
const getFileID1Change = async (e) => {
  try {
    ...
    console.log("🚀 ~ getFileID1Change ~ file:", file)
    ...
    if (!allowedTypes.includes(file.type)) {
      ...
      // Optional: Store selected file locally
      setID1Image(file);
     ...
     const formData = new FormData();
        ...
        toast.error(fileData?.payload?.Msg || "File upload failed.");
      }
                  ...
                  <Grid item xs={12} md={6}>
                    <Box display="flex" alignItems="center" gap={2}>
                      ...
                      <Button
                        ...
                        // }}
                        onClick={() => {
                          ParentcontactgetData.ContactPersonIDProofImageOne || ID1Image
                            ? window.open(
                              ID1Image
                                ? store.getState().globalurl.attachmentUrl +
                                ID1Image
                  ...
                  <Grid item xs={12} md={6}>
                    <Box display="flex" alignItems="center" gap={2}>
                      ...
                      <Button
                        ...
                        variant="contained"
                        onClick={() => {
                          ParentcontactgetData.ContactPersonIDProofImageTwo || ID2Image
                            ? window.open(
                              ID2Image
                                ? store.getState().globalurl.attachmentUrl +
                                ID2Image
