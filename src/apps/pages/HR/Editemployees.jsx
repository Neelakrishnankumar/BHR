...
const Editemployee = () => {
  ...
  const handleFormModalSubmit = (handleSubmit) => {
    return (e) => {
      e.preventDefault();
      handleSubmit(e);
      setTimeout(() => {
  ...
  //   formData.append("recordid", recID);

  //   try {
  //     setImgUploading(true);

  //     await dispatch(fnImageUpload(formData, recID, accessID));

  //     // Refresh employee data so new image is shown
            ...
            <Tooltip title="ADD">
              <IconButton
                ...
                sx={{
                  ...
                  "&:hover": {
                    background:
                      "linear-gradient(90deg, #0E9F9A 0%, #0B8A86 100%)",
                  },
                }}
              >
    ...
    <React.Fragment>
      <Box sx={{ height: "100vh", overflow: "auto" }}>
            ...
            <Box display="flex">
              ...
              {/* {mode !== "A" && (
                ...
                >
                  ...
                  <Stack mt={1}>
                    {[
                      { value: 0, label: "Personnel" },
                      { value: 5, label: "Contact" },
                      ...(is003Subscription && isStudentClassification ? [{ value: 15, label: "Parent" }] : []),
                      ...(initialValues.employeetype === "CI" ? [{ value: 8, label: getBusinessCaption("ContractIn", "Contract In") }] : []),
                      ...(is003Subscription && initialValues.employeetype === "CI" ? [{ value: 23, label: "Course Attendance" }] : []),
                      ...(initialValues.employeetype === "CO" ? [{ value: 11, label: "Contract Out" }] : []),
                      ...(is003Subscription && isStudentClassification ? [{ value: 16, label: "Parent Contact Details" }] : []),
                      { value: 1, label: getBusinessCaption("Skills", "Skills") },
                      { value: 4, label: getBusinessCaption("Deployment", "Deployment") },
                      { value: 12, label: getBusinessCaption("Approvals", "Approvals") },
                      ...(!is003Subscription ? [{ value: 2, label: "Functions" }] : []),
                      { value: 3, label: getBusinessCaption("Managers", "Managers") },
                      { value: 9, label: getBusinessCaption("Geolocation", "Geo Location") },
                      { value: 10, label: getBusinessCaption("LeaveConfigurations", "Leave Configuration") },
                      ...(!is003Subscription ? [{ value: 6, label: "List of Documents" }] : []),
                      ...(!is003Subscription ? [{ value: 20, label: "Inventory" }] : []),
                      { value: 17, label: getBusinessCaption("ItemCustody", "Item Custody") },
                      ...(!isStudentClassification ? [{ value: 14, label: getBusinessCaption("ItemServices", "Item Services") }] : []),
                      ...(!is003Subscription ? [{ value: 13, label: "Locality" }] : []),
                      ...(!is003Subscription ? [{ value: 19, label: "SOP Configuration" }] : []),
                      ...(!is003Subscription ? [{ value: 18, label: "Specimen Sign" }] : []),
                      { value: 21, label: getBusinessCaption("Documents", "Documents") },
                      ...(!isStudentClassification ? [{ value: 22, label: "Resignation" }] : []),
                    ].map((item) => (
                      <Box
                        key={item.value}
                        ...
                        sx={{
                          ...
                          borderRadius: 2,
                          cursor: "pointer",
                          backgroundColor: show == item.value ? "#EEF2FF" : "transparent",
                          borderLeft: show == item.value ? "3px solid #4F46E5" : "3px solid transparent",
                          "&:hover": { backgroundColor: show == item.value ? "#EEF2FF" : "#F3F4F6" },
                        }}
                      >
                        <Typography
                          variant="body2"
                          fontWeight={show == item.value ? 700 : 500}
                          color={show == item.value ? "#4F46E5" : "text.primary"}
                        >
                          {item.label}
                        </Typography>
                      </Box>
        ...
        <Box sx={{ p: 1, backgroundColor: "#F8F9FB", minHeight: "100vh" }}>
                    ...
                    {({
                      ...
                      >
                          ...
                          <form onSubmit={handleSubmit}>
                            ...
                            >
                              ...
                              <Box display="flex" gap={1}>
                                ...
                                <Button onClick={() => fnViewFile(values)}>
                                  View
                                </Button>
                              </Box>
                        ...
                        <Box display="flex" justifyContent="flex-end" gap={2} mt={3}>
                          ...
                          <Button variant="contained" onClick={() => fnViewFile(values)}>
                            View
                          </Button>
                    ...
                    {({
                      ...
                      >
                        ...
                        >
                          {/* <Box display="flex" justifyContent="space-between" alignItems="center" px={2} py={1.5} sx={{ backgroundColor: "#F9FAFB", borderBottom: "1px solid #E5E7EB" }}>
                            <Typography variant="body2" fontWeight={700}>
                              List of Contract In ({explorelistViewData?.length || 0})
                            </Typography>
                          </Box> */}
                                ...
                                <Box display="grid" gridTemplateColumns="repeat(2, minmax(0,1fr))" gap={2.5}>
                                  ...
                                  >
                                    ...
                                    {is003Subscription && [
                                      ...
                                      <MenuItem key="AF" value="AF">
                                        Annual Fees
                                      </MenuItem>,
                                      <MenuItem key="OF" value="OF">
                                        Other Fees
                                      </MenuItem>,
                                    ]}
                                  </TextField>
                        ...
                        <Box display="flex" justifyContent="flex-end" gap={1.5} flexWrap="wrap">
                          ...
                          {(is003Subscription && funMode === "E" && flag === "P") && (
                              ...
                              document={
                                billingTypeForPrint === "CashMemo" ? (
                                  <ContractCashMemo
                                    ...
                                    footerUrl={"/pdffooterimg.PNG"}
                                    withannexure={false}
                                    filters={{ Month: BillableMonth, Year: BillableYear, EmployeeID: recID, baseUrl: baseurl1 }}
                                    footerHeight={footerHeight}
                                  />
                                ) : (
                                  <SchoolContractInvoice
                            ...
                            >
                              {({ loading }) => (
                                <Button variant="outlined" disabled={loading} sx={{ textTransform: "none", borderRadius: 2 }}>
                                  Print Invoice
                                </Button>
                              )}
                            </PDFDownloadLink>
          ...
          {/* Leave Configuration - NEW UI STYLE */}
          {show == "10" ? (
            <Box
              display="flex"
              gap={3}
                      ...
                      >
                        ...
                        <Box sx={{ height: "45vh", mt: 2 }}>
                          <DataGrid
                            ...
                            components={{ Toolbar: Employee }}
                            onStateChange={(state) =>
                              setRowCount(state.pagination.rowCount)
                            }
                          />
                        </Box>
                ...
                <Paper elevation={0} sx={{
                  ...
                  <Box display="flex" alignItems="center" gap={1} mb={1}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Manage locality codes and information
                      </Typography>
                    </Box>
                  </Box>
                ...
                <Paper elevation={0} sx={{
                  ...
                  <Box display="flex" alignItems="center" gap={1} mb={2}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Upload and manage signature documents
                      </Typography>
                    </Box>
                  </Box>
                        ...
                        <Box display="grid" gridTemplateColumns={{ xs: "1fr", md: "1fr 1fr" }} gap={2}>
                          ...
                          <Box display="flex" alignItems="center" gap={2}>
                            <Field
                              ...
                              as={Checkbox}
                            />
                            <FormLabel>Trained By</FormLabel>
                          </Box>
                        </Box>
