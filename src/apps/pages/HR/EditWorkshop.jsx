...
const EditWorkshop = () => {
  ...
  useEffect(() => {
    dispatch(
      EventsgetData({ accessID: "TR385", get: "get", recID, Type: "W" }),
    );
  ...
  const InitialValue = {
    ...
    CertificateProvided:
      mode === "E" ? (data.CertificateProvided === "Y" ? true : false) : true,
                  ...
                  >
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/Secondarylistview/${params.accessID}/${params.screenName}/${params.leaderID}/Events/${params.secondaryAccessID}/${params.parentID2}/W`,
                          {
                            state: { ...state },
                          },
                        );
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                Organize and manage workshops and training
                                sessions
                              </Typography>
                            </Box>
                          </Box>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <MenuItem value="StudentWorkshop">
                                  Student Workshop
                                </MenuItem>
                                <MenuItem value="TeacherTraining">
                                  Teacher Training
                                </MenuItem>
                                <MenuItem value="ParentSession">
                                  Parent Session
                                </MenuItem>
                                <MenuItem value="Seminar">Seminar</MenuItem>
                                <MenuItem value="LeaveInformation">
                                  Leave Information
                                </MenuItem>
                              </TextField>
