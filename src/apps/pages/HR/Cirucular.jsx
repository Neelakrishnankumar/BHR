...
const Circular = () => {
  ...
  useEffect(() => {
    dispatch(
      EventsgetData({ accessID: "TR385", get: "get", recID, Type: "CI" }),
    );
  ...
  const Fnsave = async (values, del, override = {}) => {
    ...
    const idata = {
      ...
      AcknowledgementRequired:
        values.AcknowledgementRequired === true ? "Y" : "N",
                  ...
                  >
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/SecondarylistView/TR384/Event%20Category/${params.parentID3}`,
                          {
                            state: { ...state },
                          },
                        );
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/SecondarylistView/TR384/Event%20Category/${params.parentID3}/Events/TR385/${params.parentID2}/CI`,
                          {
                            state: { ...state },
                          },
                        );
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                Create and manage official announcements and
                                circulars
                              </Typography>
                            </Box>
                          </Box>
