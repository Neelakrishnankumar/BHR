...
const EditLeaveEnquiry = () => {
  ...
  const LeaveEnqPermission =
    sessionStorage.getItem("LeaveEnqPermission") === "Y";
  const LeaveEnqLeaveType = sessionStorage.getItem("LeaveEnqLeaveType")
    ? JSON.parse(sessionStorage.getItem("LeaveEnqLeaveType"))
    : [];
                  ...
                  >
                    ...
                    {rows.length > 0 && (
                      <PDFDownloadLink
                        ...
                        fileName={
                          isPermission
                            ? `Permission_Enquiry_Report_${state?.EmpName}.pdf`
                            : `Leave_Enquiry_Report_${state?.EmpName}.pdf`
                        }
