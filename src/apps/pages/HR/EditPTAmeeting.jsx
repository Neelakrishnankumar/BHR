...
const EditPTA = () => {
  ...
  useEffect(() => {
    dispatch(
      EventsgetData({ accessID: "TR385", get: "get", recID, Type: "PTA" }),
    );
  ...
  const Fnsave = async (values, del, override = {}) => {
    ...
    const idata = {
      ...
      AttendanceConfirmation:
        values.AttendanceConfirmation === true ? "Y" : "N",
      CreatedBy: LoginID,
    };
                  ...
                  >
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/Secondarylistview/${params.accessID}/${params.screenName}/${params.leaderID}/Events/${params.secondaryAccessID}/${params.parentID2}/PTA`,
                          {
                            state: { ...state },
                          },
                        );
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                Organize and manage parent-teacher meetings and
                                discussions
                              </Typography>
                            </Box>
                          </Box>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <MenuItem value="PTAMeeting">
                                  PTA Meeting
                                </MenuItem>
                                <MenuItem value="BoardMeeting">
                                  Board Meeting
                                </MenuItem>
                                <MenuItem value="CommitteeReview">
                                  Committee Review
                                </MenuItem>
                                <MenuItem value="Orientation">
                                  Orientation
                                </MenuItem>
                              </TextField>
