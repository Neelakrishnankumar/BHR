...
const EditCulturals = () => {
  ...
  useEffect(() => {
    dispatch(
      EventsgetData({ accessID: "TR385", get: "get", recID, Type: "C" }),
    );
  ...
  const InitialValue = {
    ...
    NotifyMail:
      mode === "E" ? (data?.NotifyEmail === "Y" ? true : false) : true,
    PassRequired:
      mode === "E" ? (data?.PassRequired === "Y" ? true : false) : true,
  };
                  ...
                  >
                    ...
                    <Typography
                      ...
                      onClick={() => {
                        // navigate("/Apps/TR243/Party");
                        navigate(
                          `/Apps/Secondarylistview/${params.accessID}/${params.screenName}/${params.leaderID}/Events/${params.secondaryAccessID}/${params.parentID2}/C`,
                          {
                            state: { ...state },
                          },
                        );
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                Manage and organize cultural events and programs
                              </Typography>
                            </Box>
                          </Box>
                          <Box
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <MenuItem value="AnnualDay">
                                  Annual Day
                                </MenuItem>
                                <MenuItem value="Dance">Dance</MenuItem>
                                <MenuItem value="Drama">Drama</MenuItem>
                                <MenuItem value="Music">Music</MenuItem>
                                <MenuItem value="ArtExhibition">
                                  Art Exhibition
                                </MenuItem>
                              ...
                              <TextField
                                ...
                                onChange={handleChange}
                                error={
                                  !!touched.ChiefGuest && !!errors.ChiefGuest
                                }
                                helperText={
                                  touched.ChiefGuest && errors.ChiefGuest
                                }
