...
const EditTerms = () => {
    ...
    useEffect(() => {
        fetch(process.env.PUBLIC_URL + "/validationcms.json")
            ...
            .then((data) => {
                ...
                let schemaFields = {
                    name: Yup.string().required(data.Terms.Description).nullable(),
                    fromdate: Yup.string().required(data.Terms.Fromdate).nullable(),
                    todate: Yup.string().nullable().required(data.Terms.Todate),
                };
    ...
    const Fnsave = async (values, del) => {
        ...
        const idata = {
            ...
            AcademicYearID: params.filtertype,
