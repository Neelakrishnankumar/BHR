...
const ListviewSecondary = () => {
  ...
  const academicYear =
    params.Type1?.match(/\d{4}-\d{2}/)?.[0] ||
    params.parentID2?.match(/\d{4}-\d{2}/)?.[0] ||
    "";
     const academicYear1 =
    params.Type?.match(/\d{4}-\d{2}/)?.[0] ||
    params.leaderID?.match(/\d{4}-\d{2}/)?.[0] ||
    "";
    const academicYear3 =
    params.parentID3?.match(/\d{4}-\d{2}/)?.[0] ||
    params.parentID2?.match(/\d{4}-\d{2}/)?.[0] ||
    "";
   const AcademicYearID =
  !/\d{4}-\d{2}/.test(params.Type1 || "")
    ? params.Type1
    : !/\d{4}-\d{2}/.test(params.parentID2 || "")
    ? params.parentID2
    : "";
      const AcademicYearID1 =
  !/\d{4}-\d{2}/.test(params.leaderID || "")
    ? params.leaderID
    : !/\d{4}-\d{2}/.test(params.Type || "")
    ? params.Type
    : "";
  ...
  if (accessID == "TR011") {
    ...
    filter = `AcademicYearID = '${AcademicYearID1}' AND CompanyID = '${compID}'`;
  }
    ...
    filter = `AcademicYearID = '${AcademicYearID}' AND AcadamicTypeID='${params.parentID}' AND CompanyID = '${compID}'`;
  }
        ...
        >
          {accessID == "TR008" || accessID == "TR054" ? (
            ...
            >
              ...
              >
                {/* Academic Year */}
                {`Academic Year(${state.AcademicYear || academicYear3})`}
              </Typography>
              <Typography
                key={8646}
                variant="h5"
                ...
                sx={{ cursor: "default" }}
                onClick={() => {
                  navigate(`/Apps/SecondarylistView/TR275/Project/${params.parentID3}/${params.parentID2}`, { state: { ...state } });
                }}
              >
                Standard/Activities
                {/* {`Standard/Activities(${state.projectName})`} */}
            ...
            >
              ...
              >
                {/* Academic Year */}
                {/* {`Academic Year(${params.Type1 || params.parentID3})`} */}
              ...
              <Typography
                ...
                sx={{ cursor: "default" }}
                onClick={() => {
                  navigate(`/Apps/SecondarylistView/TR275/Project/${params.parentID2}/${params.Type1}`, { state: { ...state } });
                }}
              >
                Standard/Activities
                {/* {`Standard/Activities(${state.projectName})`} */}
              ...
              <Typography
                ...
                sx={{ cursor: "default" }}
                onClick={() => {
                  navigate(`/Apps/SecondarylistView/TR275/Project/${params.Type1}/${params.parentID2}/Academic%20Type/TR386/L`, { state: { ...state } });
                }}
              >
            ...
            : accessID == "TR362" ? (
              ...
              <Box display="flex" borderRadius="3px" alignItems="center">
                ...
                >
                  ...
                  >
                    Academic Year ({state.AcademicYear || academicYear1})
                  </Typography>
                  <Typography
                    variant="h5"
                    color="#0000D1"
                        ...
                        onClick={async () => {
                          try {
                            ...
                            const result = await dispatch(
                              TimeTableExcelGet({ data: payload })
                            );
              ...
              <IconButton>
                <Tooltip title="Fees Structure">
                  <PaymentIcon
                    onClick={() => {
                      navigate(
                        `./Academic Type/TR386/L`,
                        {
                          state: {
                            ...state,
                            AcademicYear: params.Type,
                          }
                        }
                      );
                    }}
  ...
  console.log(academicYear, params.Type1, params.parentID2, "AAAAAAAAAA");
