...
const CandidateList = () => {
      ...
      renderCell: (params) => (
        <>
          {/* <IconButton
            onClick={() =>
              navigate(
                "/Apps/SkillGlow/SkillGlowList/CandidateList/CreateCandidates",
                {
                  state: { mode: "edit" },
                }
              )
  ...
  const rows = [
    ...
    },
    {
      ...
      sno: 3,
      name: "Angular",
      targetdate: "12-08-2025",
      lastAttdate: "12-08-2025",
      lastAttscore: "40",
      targetAttempt: "3",
    },
    {
      ...
      sno: 4,
      name: "Node JS",
      targetdate: "20-08-2025",
      lastAttdate: "20-08-2025",
      lastAttscore: "30",
      targetAttempt: "5",
    },
  ];
