...
const QuestionList = () => {
  ...
  const allRows = [
    { id: 1, sno: 1, code:"Ques01",name: "Your Educational Background", qtype: "1 Of 4" },
    {
      id: 2,
      sno: 2,
      code:"Ques05",
    ...
    { id: 3, sno: 3, code:"Ques03",name: "Is the Earth round?", qtype: "True / False" },
    { id: 4, sno: 4, code:"Ques04",name: "Are well versed with Node Js", qtype: "Yes/No" },
    {
      id: 5,
      sno: 5,
      code:"Ques05",
    ...
    { id: 6, sno: 6,code:"Ques06", name: "Find the odd one out for AWS", qtype: "5 Rates" },
    {
      id: 7,
      sno: 7,
      code:"Ques07",
