...
const CandidateMain = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <>
          {/* <IconButton color="primary" size="small" onClick={ToSkill}>
  ...
  const rows = [
    { id: 1, code: "CAT01", name: "Appraisal" },
    {
      id: 2,
      code: "CAT02",
      name: "Web Development",
    },
    { id: 3, code: "CAT03", name: "Mobile App Development" },
    { id: 4, code: "CAT04", name: "Interview" },
    { id: 5, code: "CAT05", name: "Quality Assurance" },
  ];
  ...
  const ToSkill = () => {
    navigate("/Apps/SkillGlow/Assessment/Candidates/SkillCandidate");
  };
      ...
      >
        ...
        >
          <Typography
            ...
            color="#0000D1"
            sx={{ cursor: "default" }}
            onClick={() => navigate("/Apps/SkillGlow/Assessment/Schedule/EmployeeSchedule")}
          >
        ...
        >
          ...
          {/* <Tooltip arrow title="Add">
            <IconButton>
              <AddOutlinedIcon
                onClick={() => {
                  navigate("/Apps/SkillGlow/CategoryMain/CreateCategoryMain");
                }}
              />
            </IconButton>
          </Tooltip> */}
