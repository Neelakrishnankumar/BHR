...
const CreateSkillCandidate = () => {
  ...
  const validationSchema = Yup.object({
    candidate: Yup.string().required("Please Enter Candidate Name Here"),
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  color="#0000D1"
                  sx={{ cursor: "default" }}
                  onClick={() => navigate("/Apps/SkillGlow/Assessment/Candidates/SkillCandidate")}
                >
              ...
              >
                ...
                >
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                  >
                    <MenuItem value={10}>Neelakrishnan</MenuItem>
                    <MenuItem value={20}>Ram</MenuItem>
                    <MenuItem value={30}>Shyam</MenuItem>
...
export default CreateSkillCandidate;
