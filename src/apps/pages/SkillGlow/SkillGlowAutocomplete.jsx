...
//SELF-APPRAISAL COMBO BOX
export const SelfAppraisalPayload = ({
  value = null,
  onChange,
  url,
  height = 20,
...
export const ManagerAppraisalPayload = ({
  value = null,
  onChange,
  url,
  height = 20,
...
export const PeerAppraisalPayload = ({
  value = null,
  onChange,
  url,
  height = 20,
...
export const SubordinateAppraisalPayload = ({
  value = null,
  onChange,
  url,
  height = 20,
