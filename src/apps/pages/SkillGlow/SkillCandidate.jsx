...
const SkillCandidate = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <>
          {/* <IconButton color="primary" size="small" onClick={ToSession}>
            <Tooltip title="Session">
              <AccessTimeIcon />
            </Tooltip>
          </IconButton>

          <IconButton color="primary" size="small" onClick={ToCategory}>
            <Tooltip title="Question Groups">
              <Category />
            </Tooltip>
          </IconButton> */}

          {/* <IconButton color="primary" size="small" onClick={ToCandidate}>
          ...
          <IconButton
            ...
            size="small"
            onClick={() =>
              navigate("/Apps/SkillGlow/Assessment/Candidates/SkillCandidate/CreateSkillCandidate", {
                state: { mode: "edit", skillData: params.row },
              })
            }
          >
            <Tooltip title="Edit">
  ...
  const rows = [
    ...
    { id: 3, Skill: "Basic Office Practice"},
