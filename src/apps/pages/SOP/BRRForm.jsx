...
import { batchreconciliationGetData } from "../../../store/reducers/Formapireducer";
...
function BRRForm() {
  ...
  const props = { accessID: "TR335", get: "get", recID: params.SOPDOCID };
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(batchreconciliationGetData(props));
  }, []);
        ...
        >
          ...
          >
            <tbody>
              ...
              {/* SAMPLES */}
              {["CDL + GMSD Samples", "Retention Samples", "Other Samples"].map(
                (item, index) => (
                  <tr key={index}>
                    {index === 0 && (
              ...
              <tr>
                ...
                <td>Total Number of Vials Ready for Release = (A) - (D)</td>
                <td>
                  <input
