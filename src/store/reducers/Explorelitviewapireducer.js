...
export const fetchExplorelitview =
  (AccessID, screenName, filter, any) => async (dispatch, getState) => {
    ...
    if (filter != "" && AccessID !== "TR212" && AccessID !== "TR210" && AccessID !== "TR208" && AccessID !== "TR160" && AccessID !== "TR216" && AccessID !== "TR146" && AccessID !== "TR019" && AccessID !== "TR017"&& AccessID !== "TR088" && AccessID !== "TR016"&& AccessID !== "TR125" && AccessID !== "TR126"&& AccessID !== "TR130"&& AccessID !== "TR131"&& AccessID !=="TR139") {
